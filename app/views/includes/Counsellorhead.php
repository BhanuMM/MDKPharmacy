<?php
if (!isset($_SESSION['user_id']) && ($_SESSION['urole']!="counsellor")){
...
<div class="sidebar">
    ...
    <ul style="list-style-type: none; padding-left: 0px;">
        ...
        <li><a href = "<?php echo URLROOT . "/counsellors/profilesettings/" . $_SESSION['user_id'] ?>">Profile Settings</a></li>
...
<!--        <li><img src="--><?php //echo URLROOT ?><!--/public/images/Message.png" alt="messages" height="15px" style="opacity: 0.5;"></li>-->
        <li><div class="dropdown">
                ...
                <div class="dropdown-content">
                    <p><a href="<?php echo URLROOT ?>/counsellors/profilesettings"><button class="btn-ddc">Settings</button></a></p>
