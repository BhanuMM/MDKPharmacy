...
<div align="center" style="margin-top: 8%;">
    <img src="<?php echo URLROOT ?>/public/images/mdklogo.png" style="width: 70px;"><br>
            ...
            <p style="font-size: 14px;">Enter the new password.<br><br><p>
            <form  method="post" action="<?php echo URLROOT ?>/Pages/index" style="width:30%; text-align: left;">

                <p><b>New Password :</b></p><br>
                <input class="input1" type="password" id="Runame" name="Runame" style="border: none;" placeholder="New Password">
                <br><br>
                  <p><b>Confirm New Password :</b></p><br>
                 <input class="input1" type="password" id="Runame" name="Runame" style="border: none;" placeholder="Re-enter New Password">
                 <br><br>
<!--                <p><b>Password:</b></p><br>-->
<!--                <input class="input1" type="password" id="Rpass" style="border: none; " name="Rpass" placeholder="Enter the password">-->
        ...
        <input type="submit" name="submitbutton4" value="Reset Password" class="button button1" style="margin-left: 38%; margin-top: 3%;" >
            </form>
        </div>
<br><br>  <br><br>
