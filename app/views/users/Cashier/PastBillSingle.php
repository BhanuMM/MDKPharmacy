...
<div style="margin-left:17%; padding:1px 16px; width: 40%">
    <button class="prebtn" style="margin-right: 200px;"><span><a style="text-decoration: none;" href="<?php echo URLROOT ?>/cashiers/pastbills"> << </a> </span></button>
</div>  
            ...
            <table class="table-bordered" id="tableData">
                ...
                <?php endforeach; ?>
                    ...
                    <tr>
                        ...
                        <td> <input  id="dis" name="dis" type="text" autocomplete="off" readonly></td>
                    </tr>
                    <tr>
